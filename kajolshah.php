	...
	<body>
		...
		<div class="wrapper">
			<div class="sidebar">
				<h2>Pharmacy</h2>
				<ul>
		 			<li><a href="pharmacy.php">Rahman Pharmacy</a></li>
		 			<li><a href="sylhet.php">Raiyan Pharmacy</a></li>
		 			<li><a href="naiorpul.php">Naiorpul Pharmacy</a></li>
		 			<li><a href="kajolshah.php">Al-Madina Pharmacy</a></li>
		 		</ul>
			</div>
			<div class ="about">
			<div class="main_content">
				<div class="header"><h1>Al-Madina Pharmacy</h1><br> Contact:01842429020 </br> Email:almadina.pharmacy@gmail.com</br>
				<div class="info">	
					
					<div class="ex">
		 			 <img src="Medicine/99.jpg"/>
					 <p> Glaves </br> Taka:45</p>
					</div>
					<div class="ex">
		 			 <img src="Medicine/aspirin.jpg"/>
					 <p> Aspirin </br> Taka:30</p>
					</div>
					<div class="ex">
		 			 <img src="Medicine/avomin.jpg"/>
					 <p> Avomin </br> Taka:180</p>
					</div>
					<div class="ex">
		 			 <img src="Medicine/dettol.jpg"/>
					 <p> Dettol </br> Taka:30</p>
					</div>
					<div class="ex">
		 			 <img src="Medicine/devomin.jpg"/>
					 <p> Devomin </br> Taka:15</p>
					</div>
					<div class="ex">
		 			 <img src="Medicine/hexisol.jpg"/>
					 <p> Hexisol </br> Taka:35</p>
					</div>
					</div>
		 		</div>
				</div>
